                   ...
                   fluidRow(
                     ...
                     column(8, 
                            ...
                            selectInput("gene_cellline", label = "Gene Symbol", 
                                        choices=as.vector(unique(ccle$GeneName)), selected=default_gene,multiple=TRUE
                            )
                   ...
                   fluidRow(
                     column(8,
                            selectInput("cellline_hpa", label = "Cell-line (HPA)", 
                                        choices=as.vector(unique(hpa_cellline$cellline)), selected=c('AF22','A-431','Daudi'),multiple=TRUE
                            )
